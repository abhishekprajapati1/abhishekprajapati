...
const SelectedTag: FC<SelectedTagProps> = ({ label, onClose }) => {
    return (
        <div className='rounded-xl bg-background dark:bg-foreground text-foreground dark:text-background border  border-gray-400 px-2 py-1 flex items-center gap-2'>
